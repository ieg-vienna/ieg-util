 ...
 *               patch 1577221 (DG);
 * ------------- LOCAL CHANGES ------------------------------------------------
 * 12-Sep-2010 : make output of year optional 
 *
 */
...
public class QuarterDateFormat extends DateFormat
     ...
     * Creates a new instance for the default time zone.
     */
    public QuarterDateFormat(boolean showYear, String quarterPrefix, boolean quarterFirst) {
        this();
        this.showYear = showYear;
        this.quarterPrefix = quarterPrefix;
        this.quarterFirst = quarterFirst;
        
        this.quarters = ROMAN_QUARTERS;
    }
    ...
    public StringBuffer format(Date date, StringBuffer toAppendTo,
        ...
        if (this.quarterFirst) {
       		toAppendTo.append(this.quarterPrefix);
